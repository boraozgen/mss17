...
SC_MODULE(Testbench) {
	sc_fifo<int> arc[12];
	sc_fifo<int> data_src_adp_in, ADD_4_adp_in;
	Adapter<int, 3> data_src_adp;
	Adapter<int, 3> ADD_4_adp;
		...
		DEC("DEC", 10)
	{
		...
		data_src.output(data_src_adp_in);

		data_src_adp.input(data_src_adp_in);
		data_src_adp.out[0](arc[0]);
		data_src_adp.out[1](arc[1]);
		data_src_adp.out[2](arc[2]);
		...
		ADD_4.in1(arc[5]);
		ADD_4.in2(arc[9]);
		ADD_4.out(ADD_4_adp_in);

		ADD_4_adp.input(ADD_4_adp_in);
		ADD_4_adp.out[0](arc[6]);
		ADD_4_adp.out[1](arc[8]);
		ADD_4_adp.out[2](arc[10]);
